document.addEventListener('DOMContentLoaded', () => {
    ...
    currentScoreElement.textContent = snake.length - 1;
    highScoreElement.textContent = highScore;

    resultModal.style.display = 'block';

    // Dodajte event listener za zatvaranje moda putem X gumba
    ...
    function resetGame() {
      ...
      gameSpeedDelay = 200;
      updateScore();
      displayGameOver();     // Calling this last because we need to call it under the rest of snake variable
    }
